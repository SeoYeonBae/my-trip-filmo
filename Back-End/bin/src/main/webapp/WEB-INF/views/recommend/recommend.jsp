...
<!-- 중앙 content end -->
<script>
  let todayTitle = "${keywordRecommend}"; // 오늘의 관광지, 공연, 맛집
  var map;
  ...
  function getNewData() {
    var typeId = "${typeId}"; // 오늘의 관광지, 공연, 맛집 각각의 content_type_id
    ...
    fetch(`${root}/tourlist/recommend/${typeId}`, config)
  ...
  function getTitle() {
    ...
    let title = `
        <h2 class="mt-5 pt-3 fw-bold text-center">\${todayTitle}</h2>
        `;
  ...
  function Origin_showPlaceInfo(data) {
